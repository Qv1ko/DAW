...
/*
 * No coincide porque no tiene caracteres diferentes a los que estan entre corchetes, despues de la
 *  cadena "Java".
 */
// - ¿Y en la cadena JavaScript?
console.log(`"JavaScript" = ${/Java[^script]/.test("JavaScript")}`);
/*
 * Coincide porque despues de la cadena "Java" hay un carácter que no estar entre los corchetes.
 */
 ...
 */
console.log(`"#3f3" = ${/^#([0-9a-fA-F]){3,6}$/.test("#3f3")}`);
console.log(`"#3f3d" = ${/^#[0-9a-fA-F]{3,6}$/.test("#3f3d")}`);
console.log(`"#AA00ef" = ${/^#[0-9a-fA-F]{3,6}$/.test("#AA00ef")}`);
console.log(`"#abcd" = ${/^#[0-9a-fA-F]{3,6}$/.test("#abcd")}`);
console.log(`"#Af" = ${/^#[0-9a-fA-F]{3,6}$/.test("#Af")}`);
console.log(`"#ytcd" = ${/^#[0-9a-fA-F]{3,6}$/.test("#ytcd")}`);

console.log("Cuestion 7:");
/*
