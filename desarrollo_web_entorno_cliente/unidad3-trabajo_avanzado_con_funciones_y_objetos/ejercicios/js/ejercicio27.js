...
/*
 * Crea una nueva clase RelojExtendido que herede de Reloj y agregue la propiedad precision: este
 *  es el número de milisegundos que entre "tics", es decir, el número de milisegundos entre cada
